...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    addToast('Signup functionality coming soon with Supabase Auth!', 'info')
    setIsLoading(false)
  }
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-heli-dark">Create an account</h1>
          <p className="text-gray-500 mt-1">Join the Heli community today</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-heli-dark mb-1">Full Name</label>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/login" className="text-heli-blue hover:underline">
            Sign in
          </Link>
        </p>
      </div>
